      ...
      <div className="flex flex-col h-full bg-stone-50">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-8 text-center gap-5">
          ...
          <div>
            ...
            <p className="text-sm text-stone-500 leading-relaxed">The PIP Diary is available to Full Access users. Unlock for £8.99 one-time.</p>
          </div>
          <button onClick={() => navigateTo('upsell')} className="w-full bg-teal-700 text-white py-3.5 rounded-xl font-semibold text-base hover:bg-teal-800 active:scale-[0.98] transition-all shadow-sm">Unlock Full Access — £8.99</button>
        </div>
      </div>
    );
  }
