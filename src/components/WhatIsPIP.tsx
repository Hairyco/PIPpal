      ...
      <div className="bg-white rounded-2xl border border-stone-100 shadow-sm overflow-hidden">
        <div className="p-5">
          ...
          <p className="text-sm text-stone-600 leading-relaxed mb-3">
            Personal Independence Payment (PIP) is a tax-free benefit for people aged 16 to State Pension age who have a health condition or disability that affects their daily life or mobility. You do not need a formal diagnosis to apply. Your condition must have affected you for at least 3 months and be expected to continue for at least another 9 months. Even if you're not sure you qualify, you can still apply and be assessed.
          </p>
          <p className="text-sm text-stone-600 leading-relaxed mb-3">
