        ...
        <section>
          ...
          {hasPaid ? (
            ...
            <div className="bg-stone-50 rounded-2xl p-5 border border-stone-200 text-center">
              ...
              <button onClick={() => navigateTo('upsell')} className="bg-teal-700 text-white text-xs font-bold px-4 py-2 rounded-lg hover:bg-teal-800 transition-colors">Unlock Full Access — {formatFullAccessPrice()}</button>
            </div>
          )}
        </section>
        <section>
...
export function TermsScreen() {
  const sections = [
    ...
    { title: '5. Payment terms', body: `Full Access is available for a one-time payment of ${formatFullAccessPrice()}. This payment is non-refundable once Full Access has been granted and you have accessed the paid content. All payments are processed securely by Stripe. We do not store your payment card details.` },
