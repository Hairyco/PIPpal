...
export function Hero({ onStart }: HeroProps) {
  ...
  return (
    <section className="px-5 md:px-8 pt-4 md:pt-8 pb-8 md:pb-14 flex flex-col items-center text-center max-w-4xl mx-auto">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold text-stone-900 leading-tight mb-3 md:mb-6">
      ...
      >
        <div className="bg-white rounded-2xl shadow-md border border-stone-100 mb-5 overflow-hidden">
          ...
          <div className="flex gap-2">
            ...
            <button type="button" onClick={onEligibility}
              className="flex-1 bg-white border-2 border-teal-600 text-teal-700 py-3 rounded-xl font-bold text-base flex items-center justify-center active:scale-[0.98] transition-all hover:bg-teal-50">
              Check eligibility
            </button>
          </div>
