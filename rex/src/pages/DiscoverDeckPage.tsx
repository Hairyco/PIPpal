...
function TrenchesIcon({ className = '' }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      <path
        d="M8 14c0-2.2 1.8-4 4-4s4 1.8 4 4v5H8v-5Z"
        stroke="currentColor"
        strokeWidth="1.6"
      />
      <path
        d="M7 10.5 9.5 6h5L17 10.5"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        ...
        <div className="pointer-events-auto flex w-full max-w-[22rem] items-center justify-between rounded-[22px] bg-[#1c1c1e]/92 px-2 py-2 shadow-[0_12px_40px_rgba(0,0,0,0.55)] ring-1 ring-white/10 backdrop-blur-md">
          ...
          >
            <span className="grid h-8 w-8 place-items-center rounded-full bg-white/15">
              <Compass className="h-[18px] w-[18px] text-white" strokeWidth={2} />
            </span>
          ...
          <button type="button" className="flex w-[18%] flex-col items-center gap-0.5 text-white/45">
            <TrenchesIcon className="h-[18px] w-[18px]" />
            <span className="text-[10px] font-medium">Trenches</span>
          </button>
          <button type="button" className="flex w-[18%] flex-col items-center gap-0.5 text-white/45">
