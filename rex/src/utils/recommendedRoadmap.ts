import { DUAL_FEE_SHORT } from '../data/chainConfig';
...
function baseMilestones(
  ...
  if (horizon === '2-3-years') {
    return [
      ...
      },
      {
        ...
        description:
          `Buy/sell tax (${DUAL_FEE_SHORT}) on curve trades flows into your marketing wallet. Rex runs sustained community and listing growth.`,
        unlock: 'Year 1',
      },
      {
        step: 3,
  ...
  return [
    ...
    },
    {
      ...
      title: 'Marketing wallet fills',
      description:
        `Buy/sell tax (${DUAL_FEE_SHORT}) on curve trades flows into your marketing wallet. Rex runs Telegram, DexScreener, and trending placements.`,
      unlock: 'Month 1–2',
    },
    {
      step: 3,
