...
type DashTab = 'overview' | 'wallet' | 'socials';
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="mt-1.5 text-sm text-white/45">
              Trade fees fill this vault. Spend unlocks with the roadmap below — powered by
              Polessia.
            </p>
          </div>
          ...
          <div className="space-y-4 border-t border-white/[0.06] pt-6">
            <div>
              <p className="text-[11px] font-medium text-white/45">Spend roadmap</p>
              <p className="mt-1.5 text-sm text-white/45">
