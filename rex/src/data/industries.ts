...
export const industries: Industry[] = [
  ...
  },
  {
    id: 'miscellaneous',
    name: 'Miscellaneous',
    description: 'Everything else — niche ideas and industries not covered elsewhere',
    projectCount: 412,
    tag: 'Catch-all',
    image: industryImage('miscellaneous', '/images/industries/miscellaneous.jpg'),
    icon: industryIcon('miscellaneous', '/images/industries/icons/miscellaneous.svg'),
  },
];
